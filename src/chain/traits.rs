...
pub trait ReadInterface<K: Num, E: PairingEngine> {
    ...
    fn read_bplus_tree_node(&self, bplus_tree_node_id: BPlusTreeNodeId)
...
pub trait WriteInterface<K: Num, E: PairingEngine> {
