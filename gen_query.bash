...
cargo run --release --bin gen_query -- -r -t 100 -d 1 -s 0.01 -g 2000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/range_t100_s01
cargo run --release --bin gen_query -- -r -t 500 -d 1 -s 0.05 -g 5000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/range_t500_s05
cargo run --release --bin gen_query -- -r -t 1000 -d 1 -s 0.1 -g 10000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/range_t1000_s1
...
cargo run --release --bin gen_query -- -b -f -t 100 -d 1 -s 0.01 -n 1 -g 2000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t100_n1
cargo run --release --bin gen_query -- -b -f -t 100 -d 1 -s 0.01 -n 2 -g 2000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t100_n2
cargo run --release --bin gen_query -- -b -f -t 100 -d 1 -s 0.01 -n 4 -g 2000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t100_n4
cargo run --release --bin gen_query -- -b -f -t 500 -d 1 -s 0.05 -n 1 -g 50000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t500_n1
cargo run --release --bin gen_query -- -b -f -t 500 -d 1 -s 0.05 -n 2 -g 50000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t500_n2
cargo run --release --bin gen_query -- -b -f -t 500 -d 1 -s 0.05 -n 4 -g 50000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t500_n4
cargo run --release --bin gen_query -- -b -f -t 1000 -d 1 -s 0.1 -n 1 -g 10000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t1000_n1
cargo run --release --bin gen_query -- -b -f -t 1000 -d 1 -s 0.1 -n 2 -g 10000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t1000_n2
cargo run --release --bin gen_query -- -b -f -t 1000 -d 1 -s 0.1 -n 4 -g 10000 -i ./data/db/eth_small_254/t2_id2_b4 -o ./data/query/generated_query/both_t1000_n4
